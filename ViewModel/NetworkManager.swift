...
class OpenAIService {
    ...
    func generateURLRequest(httpMethod: HTTPMethod, message: String) async throws -> URLRequest {
        ...
        let top5MindfulStuff = GPTFunctionProperty(type: "string", description: "A list of the top 5 things I've been mindful of.")
        ...
        let function = GPTFunction(name: "get_summary", description: "Summarize my month or year based on the set of inputs and please do not make things up", parameters: functionParams)
